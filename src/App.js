...
const handleDateChane = (e) => {
  ...
  return (
    <div className="flex flex-col items-center mt-5 bg-slate-500 h-screen">
       <Title title={name} />
       <Title title={date} />
        <input  type='text'  className="m-3  w-96 text-center p-3" onChange={handleNameChane} />
        <input  type='date'   className="m-3  w-96 text-center p-3" onChange={handleDateChane} />
